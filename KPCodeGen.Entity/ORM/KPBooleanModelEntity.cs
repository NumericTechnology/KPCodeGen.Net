...
namespace KPCodeGen.Entity.ORM
{
    ...
    /// </summary>
    [ActiveRecord(Table = "KPBOOLEANMODEL")]
    public class KPBooleanModelEntity : KPEntitySQLLiteBase<KPBooleanModelEntity>
    {
        [Browsable(false)]
        [PrimaryKey(Column = "ID_KPBOOLEANMODEL")]
        ...
        [KPCategory("KPEntity_Category_Property")]
        [KPDisplayName("KPEntity_CustomTrue")]
        [KPDescription("KPEntity_CustomTrue_Description")]
        [Property(Column = "CUSTOM_TRUE", Length = 255)]
        public virtual string CustomTrue { get; set; }

        [KPCategory("KPEntity_Category_Property")]
        [KPDisplayName("KPEntity_CustomFalse")]
        [KPDescription("KPEntity_CustomFalse_Description")]
        [Property(Column = "CUSTOM_FALSE", Length = 255)]
        public virtual string CustomFalse { get; set; }
