...
namespace KPCodeGen.Entity.ORM
{
    ...
    /// </summary>
    [ActiveRecord(Table = "KPFORMITEMCHECKBOX")]
    public class KPFormItemCheckBoxEntity : KPEntitySQLLiteBase<KPFormItemCheckBoxEntity>
    {
        [Browsable(false)]
        [PrimaryKey(Column = "ID_KPFORMITEMCHECKBOX")]
        ...
        [Property(Column = "DESCRIPTION", Length = 255)]
        ...
        [DefaultValue(false)]
        [KPCategory("KPEntity_Category_Property")]
        [Property(Column = "IS_GROUP_STYLE_DISPLAY")]
        public virtual bool IsGroupStyleDisplay { get; set; }
        ...
        [Property(Column = "KPEVENT_CHECKBOXSELECT")]
        public virtual bool KPEventCheckBoxSelect { get; set; }
        #endregion
