...
namespace KPCodeGen.Entity.ORM
{
    ...
    /// </summary>
    [ActiveRecord(Table = "KPFORMITEMPASSWORD")]
    public class KPFormItemPasswordEntity : KPEntitySQLLiteBase<KPFormItemPasswordEntity>
    {
        [Browsable(false)]
        [PrimaryKey(Column = "ID_KPFORMITEMPASSWORD")]
