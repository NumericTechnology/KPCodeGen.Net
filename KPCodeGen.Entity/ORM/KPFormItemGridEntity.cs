...
namespace KPCodeGen.Entity.ORM
{
    ...
    /// </summary>
    [ActiveRecord(Table = "KPFORMITEMGRID")]
    public class KPFormItemGridEntity : KPEntitySQLLiteBase<KPFormItemGridEntity>
    {
        [Browsable(false)]
        [PrimaryKey(Column = "ID_KPFORMITEMGRID")]
        ...
        [KPDescription("KPEntity_KPEventDeleteLine_Description")]
        [Property(Column = "KPEVENT_DELETELINE")]
        public virtual bool KPEventDeleteLine { get; set; }
        #endregion
    }
}
